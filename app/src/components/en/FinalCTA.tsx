      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-md text-white">
            ...
            <span className="font-medium">Support women's empowerment</span>
          </div>

          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
            With your help, we build a more equal future
          </h2>

          <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            1001 Nomads is a digital platform for empowering Iranian women.
            Your support helps narrow the gender gap in Iran.
          </p>
          ...
          <div className="max-w-2xl mx-auto space-y-6 pt-8">
            ...
            <p className="text-white/80 text-sm">
              Every contribution, big or small, makes a real difference in women's lives.
            </p>
          </div>
        </div>
      </div>
