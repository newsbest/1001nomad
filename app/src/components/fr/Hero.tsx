        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in-up">
            <Badge className="bg-accent/20 text-accent border-accent/30 hover:bg-accent/30 text-lg px-4 py-2 w-fit">
              ...
              Autonomisation des femmes iraniennes
            </Badge>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight">
              1001 <span className="text-gradient-primary">Nomades</span>
            </h1>

            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl">
              Une plateforme numérique pour l'autonomisation des femmes iraniennes
              à travers les médias, la formation aux compétences, le mentorat et{" "}
              <span className="font-bold text-accent">
                une connexion sécurisée au monde
              </span>.
            </p>
